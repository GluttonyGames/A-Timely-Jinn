...
view_xport[0] = 0;
view_yport[0] = 0;
view_wport[0] = (_w / 2)-2; // We want the window to be 960x540 so set the view port to half the width
view_hport[0] = _h;
view_camera[0] = camera_create_view(0, 0, _w / 2, _h, 0, obj_player1, -1, -1, _w, _h);

// Set up camera for view[1] (player 2)
view_visible[1] = true;
view_xport[1] = (_w / 2)+2; // Offset the second view for player two within the game window
view_yport[1] = 0;
view_wport[1] = (_w / 2)-2;
view_hport[1] = _h;
